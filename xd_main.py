...
if __name__ == "__main__":
    ...
    wind = Visualizer(env = 'XD_DTCL', port = "2023", use_incoming_socket = False)
    ...
    for step in tqdm(
        ...
        if step % 10 == 0 and step > 10:
            ...
            if test_info["ap"][-1] > best_auc:
                ...
                print('step: {}, best_ap: {}'.format(step, best_auc))

                utils.save_best_record(test_info, 
                    os.path.join(config.output_path, "xd_best_record_{}.txt".format(config.exp_xd_index)))

                torch.save(net.state_dict(), os.path.join(args.model_path, \
                    "xd_trans_{}.pkl".format(config.exp_xd_index)))
