...
import utils
import os
from modules.model import DTCL
...
if __name__ == "__main__":
    ...
    net = DTCL(config.len_feature, flag = "Test", a_nums = 60, n_nums = 60)
    net = net.to("cuda:1")
    ...
    valid(net, config, test_loader, model_file = os.path.join(args.model_path, "xd_best.pkl"))
    end_time = time.time()
